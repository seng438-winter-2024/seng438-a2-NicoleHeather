...
|    Nora             | calculateColumnTotalWithMultipleColumns, calculateColumnTotalWithMissingValues, calculateColumnTotalWithEmptyColumn,  | Varying input amounts, InvalidParameterException, Missing values, Null
|                     |   calculateColumnTotalWithOneColumn, calculateColumnTotalWithNullDataObject                              | Varying input amounts, InvalidParameterException, Missing values, Null
| calculateRowTotal   | calculateRowTotalWithNullDataObject, calculateRowTotalForTwoValues, calculateRowTotalWithZeroInput |
