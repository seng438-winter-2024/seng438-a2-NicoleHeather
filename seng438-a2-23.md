...
The purpose of this testing strategy is to faciliate pair programming, organize resources, assign individual and group tasks 
...
- System Resources:
  ...
  |----|-----------|----------------------------------|
  | 1. | Computer  | Needs to be able to run Ecclipse | 
...
|    Nicole           | GetCentralValue_ZeroPositiveRange, GetCentralValue_ZeroNegativeRange, GetCentralValue_BothZero,         | ** ADD RANGES **
|                     | GetCentralValue_EqualNegative, GetCentralValue_EqualPositive, GetCentralValue_LargeRange,               | ** COMMENT your code **
