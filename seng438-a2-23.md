...
***We assumed that the TA will test our code by importing the JUnit java files into the library of another project.***

***As another precaution we have provided a folder names JUnitTests that contains the java file made without the libraries from eclipse***
